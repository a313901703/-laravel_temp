  ...
  <tr>
        <td>
            <table colspan="4" align="center" border="0" cellpadding="0" cellspacing="0" class="main-table" width="420" style="border-collapse: collapse;min-width: 420px;max-width: 420px">
                ...
                <tr>
                    <td colspan="4" align="center" class="title" style="font-size:30px;font-family:'Times New Roman';font-weight:900;color:rgb(225,225,225);padding-top:10px;padding-bottom: 20px;border-bottom: 2px solid rgb(181 172 165);">
                      We Miss You!
                    </td>
                </tr>
                <tr>
                ...
                <tr>
                    <td colspan="4" align="center" style="font-size:16px;line-height:24px;font-family:'Times New Roman';color:rgb(225,225,225);padding-top:5px;padding-bottom: 10px;">
                      We noticed you haven’t been around lately, what happened…did the robot say something?
                    </td>
                </tr>
                <tr>
                    <td colspan="4" align="center" style="font-size:16px;line-height:24px;font-family:'Times New Roman';color:rgb(225,225,225);padding-top:10px;padding-bottom: 10px;">
                      Come back! You’re <span style="color:rgb(3 169 244)">{{$cups}}</span> drinks away from a free beverage through the RC COFFEE app with RC rewards. You're almost there!
                    </td>
                </tr>
                <tr>
                    <td colspan="4" align="center" style="font-size:16px;line-height:24px;font-family:'Times New Roman';color:rgb(225,225,225);padding-top:10px;padding-bottom: 10px;">
